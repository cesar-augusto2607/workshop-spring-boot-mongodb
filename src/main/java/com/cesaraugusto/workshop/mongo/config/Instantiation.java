package com.cesaraugusto.workshop.mongo.config;
...
import com.cesaraugusto.workshop.mongo.DTO.AuthorDTO;
import com.cesaraugusto.workshop.mongo.DTO.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c1 = new CommentDTO("Boa viagen mano",sdf.parse("21/03/2025"), new AuthorDTO(alex));
		CommentDTO c2 = new CommentDTO("Aproveite", sdf.parse("22/03/2025"), new AuthorDTO(bob));
		CommentDTO c3 = new CommentDTO("Tenha uma otimo dia", sdf.parse("23/03/2025"), new AuthorDTO(alex));
